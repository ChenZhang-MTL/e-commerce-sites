...
<div class="Row">
	<div class="card">
  	    <img src="../../images/Women/DRESSES/1hmgoepprod.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/1_hmgoepprod.jpg" alt="Denim Jeans" class="img-top">
       	<h1>Slim Jeans</h1>
	...
	<div class="card">
        <img src="../../images/Women/DRESSES/2hmgoepprod.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/2_hmgoepprod.jpg" alt="Denim Jeans" class="img-top">
        <h1>Loose Jeans</h1>
  	...
  	<div class="card">
        <img src="../../images/Women/DRESSES/3hmgoepprod.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/3_hmgoepprod.jpg" alt="Denim Jeans" class="img-top">
        <h1>Skinny Jeans</h1>
    ...
    <div class="card">
        <img src="../../images/Women/DRESSES/4hmgoepprod.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/4_hmgoepprod.jpg" alt="Denim Jeans" class="img-top">
        <h1>Skinny Jeans</h1>
        <p class="price">$29.99</p>
        <p>New Arrival<br>5-pocket crop jeans in stretch cotton denim. Regular waist, zip fly with button, and skinny legs.</p>
        <p><button>Add to Cart</button></p>
...
<div class="Row">
	<div class="card">
        <img src="../../images/Women/DRESSES/4-1.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/4-2.jpg" alt="Denim Jeans" class="img-top">
	...
	<div class="card">
        <img src="../../images/Women/DRESSES/3-1.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/3-2.jpg" alt="Denim Jeans" class="img-top">
        <h1>Slim Jeans</h1>
        <p class="price">$29.99</p>
  	...
  	<div class="card">
        <img src="../../images/Women/DRESSES/6-1.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/6-2.jpg" alt="Denim Jeans" class="img-top">
        <h1>Skinny Jeans</h1>
        <p class="price">$39.99</p>
    ...
    <div class="card">
        <img src="../../images/Women/DRESSES/5-1.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/5-2.jpg" alt="Denim Jeans" class="img-top">
        <h1>Skinny Jeans</h1>
        <p class="price">$29.99</p>
...
<div class="Row">
	<div class="card">
        <img src="../../images/Women/DRESSES/5hmgoepprod.jpg" alt="Denim Jeans">
	...
	<div class="card">
        <img src="../../images/Women/DRESSES/6hmgoepprod.jpg" alt="Denim Jeans">
  	...
  	<div class="card">
        <img src="../../images/Women/DRESSES/7hmgoepprod.jpg" alt="Denim Jeans">
    ...
    <div class="card">
        <img src="../../images/Women/DRESSES/8hmgoepprod.jpg" alt="Denim Jeans">
...
<div class="Row">
	<div class="card">
        <img src="../../images/Women/DRESSES/7-1.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/7-2.jpg" alt="Denim Jeans" class="img-top">
	...
	<div class="card">
        <img src="../../images/Women/DRESSES/8-1.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/8-2.jpg" alt="Denim Jeans" class="img-top">
        <h1>Slim Jeans</h1>
        <p class="price">$29.99</p>
        <p>New Arrival<br>5-pocket jeans in stretch cotton denim. Regular waist, zip fly with button, and slim legs.</p>
        <p><button>Add to Cart</button></p>
  	...
  	<div class="card">
        <img src="../../images/Women/DRESSES/9-1.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/9-2.jpg" alt="Denim Jeans" class="img-top">
        <h1>Skinny Jeans</h1>
        <p class="price">$39.99</p>
        <p>5-pocket jeans in washed stretch denim with heavily distressed details. Regular waist, zip fly with button, and skinny legs.</p>
        <p><button>Add to Cart</button></p>
    ...
    <div class="card">
        <img src="../../images/Women/DRESSES/10-1.jpg" alt="Denim Jeans">
        <img src="../../images/Women/DRESSES/10-2.jpg" alt="Denim Jeans" class="img-top">
        <h1>Skinny Jeans</h1>
        <p class="price">$29.99</p>
        <p>New Arrival<br>5-pocket crop jeans in stretch cotton denim. Regular waist, zip fly with button, and skinny legs.</p>
        <p><button>Add to Cart</button></p>
